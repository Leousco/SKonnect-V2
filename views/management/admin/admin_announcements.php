                    ...
                    <div class="ann-form-card">
                        ...
                        <div class="ann-form-section">
                            ...
                            <div class="ann-field-group">
                                ...
                                <div id="ann-body"
                                     ...
                                     style="min-height:160px;border-top:none;border-radius:0 0 8px 8px;padding:12px 14px;outline:none;"
                                     data-placeholder="Write the full details of the announcement here…"></div>
                            </div>
                        </div>

                        <div class="ann-form-divider"></div>

                        <!-- SECTION 03: Category & Settings -->
                        <div class="ann-form-section">
                            <div class="ann-section-header">
                            ...
                            <div class="ann-two-col">
                                <div class="ann-field-group">
                                    ...
                                    <div class="ann-category-grid">
                                        <label class="ann-cat-option"><input type="radio" name="category" value="event"><span class="ann-cat-card cat-event-card"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5"/></svg>Event</span></label>
                                        <label class="ann-cat-option"><input type="radio" name="category" value="program"><span class="ann-cat-card cat-program-card"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.627 48.627 0 0 1 12 20.904a48.627 48.627 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.57 50.57 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0 1 12 13.489a50.702 50.702 0 0 1 3.741-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5"/></svg>Program</span></label>
                                        <label class="ann-cat-option"><input type="radio" name="category" value="meeting"><span class="ann-cat-card cat-meeting-card"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z"/></svg>Meeting</span></label>
                                        <label class="ann-cat-option"><input type="radio" name="category" value="notice"><span class="ann-cat-card cat-notice-card"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 0 1-3-3V4.5a3 3 0 1 1 6 0v8.25a3 3 0 0 1-3 3Z"/></svg>Notice</span></label>
                                        <label class="ann-cat-option"><input type="radio" name="category" value="urgent"><span class="ann-cat-card cat-urgent-card"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z"/></svg>Urgent</span></label>
                                    </div>
                                </div>
                                    ...
                                    <div class="ann-field-group">
                                        ...
                                        <div class="ann-toggle-card" id="featured-toggle-card">
                                            <div class="ann-toggle-info">
                                                ...
                                                <div><strong>Mark as Featured</strong><p>Displays prominently on the member portal dashboard.</p></div>
                                            </div>
                                            <label class="ann-switch"><input type="checkbox" id="featured-checkbox"><span class="ann-switch-track"></span></label>
                                        </div>
                                    </div>
                                    <div class="ann-field-group">
                        ...
                        <div class="ann-form-actions">
                            ...
                            <div class="form-actions-right">
                                <button type="button" class="btn-ann-primary" id="btn-publish">
                ...
                <aside class="ann-preview-col">
                    <div class="ann-preview-sticky">
                        ...
                        <div class="ann-preview-card" id="preview-card">
                            ...
                            <div class="preview-body">
                                <div class="preview-meta-row">
                                    ...
                                    <span class="preview-date" id="preview-date"><?= date('M d, Y') ?></span>
                                </div>
                                ...
                                <div class="preview-attach-row" id="preview-attach-row" style="display:none;">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 0 1-6.364-6.364l10.94-10.94A3 3 0 1 1 19.5 7.372L8.552 18.32m.009-.01-.01.01m5.699-9.941-7.81 7.81a1.5 1.5 0 0 0 2.112 2.13"/></svg>
                                    <span id="preview-attach-count">0 attachments</span>
                                </div>
                                <div class="preview-footer">
                                    <span class="preview-posted-by">Posted by <strong><?= htmlspecialchars($_SESSION['user_name'] ?? 'Admin') ?></strong></span>
                        ...
                        <div class="ann-checklist">
                            ...
                            <div class="ann-checklist-item" id="check-banner"><svg class="check-icon check-empty" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><circle cx="12" cy="12" r="9"/></svg><svg class="check-icon check-done" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="display:none;"><path stroke-linecap="round" stroke-linejoin="round" d="m9 12.75 3 3 6-6m-9.75 5.25A9 9 0 1 1 21 12a9 9 0 0 1-18 0Z"/></svg><span>Banner image</span></div>
                            <div class="ann-checklist-item" id="check-title"><svg class="check-icon check-empty" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><circle cx="12" cy="12" r="9"/></svg><svg class="check-icon check-done" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="display:none;"><path stroke-linecap="round" stroke-linejoin="round" d="m9 12.75 3 3 6-6m-9.75 5.25A9 9 0 1 1 21 12a9 9 0 0 1-18 0Z"/></svg><span>Title entered</span></div>
                            <div class="ann-checklist-item" id="check-body"><svg class="check-icon check-empty" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><circle cx="12" cy="12" r="9"/></svg><svg class="check-icon check-done" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="display:none;"><path stroke-linecap="round" stroke-linejoin="round" d="m9 12.75 3 3 6-6m-9.75 5.25A9 9 0 1 1 21 12a9 9 0 0 1-18 0Z"/></svg><span>Details written</span></div>
                            <div class="ann-checklist-item" id="check-category"><svg class="check-icon check-empty" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><circle cx="12" cy="12" r="9"/></svg><svg class="check-icon check-done" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="display:none;"><path stroke-linecap="round" stroke-linejoin="round" d="m9 12.75 3 3 6-6m-9.75 5.25A9 9 0 1 1 21 12a9 9 0 0 1-18 0Z"/></svg><span>Category selected</span></div>
                        </div>
                    </div>
                </aside>
...
<div id="ann-confirm-overlay" style="display:none;position:fixed;inset:0;background:rgba(30,27,74,.45);z-index:1000;align-items:center;justify-content:center;">
    <div style="background:#fff;border-radius:12px;padding:28px 32px;max-width:380px;width:100%;box-shadow:0 8px 40px rgba(91,33,182,.2);">
        ...
        <p style="font-size:13px;color:#6b7280;margin-bottom:24px;" id="confirm-msg">Are you sure?</p>
        <div style="display:flex;gap:10px;justify-content:flex-end;">
            <button id="confirm-cancel" style="padding:9px 18px;font-size:13px;font-weight:600;border:1.5px solid #ddd6fe;border-radius:8px;background:#fff;cursor:pointer;color:#6b7280;">Cancel</button>
            <button id="confirm-ok"     style="padding:9px 18px;font-size:13px;font-weight:700;border:none;border-radius:8px;background:#dc2626;color:white;cursor:pointer;">Delete</button>
        </div>
    </div>
</div>

<script src="../../../scripts/management/admin/admin_announcements.js?v=<?= time() ?>"></script>
</body>
</html>