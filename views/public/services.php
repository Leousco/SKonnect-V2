                                ...
                                <ul class="pub-details-list <?= $hasCapacity ? 'pub-details-list--slots' : '' ?>">
                                    ...
                                    <?php else : ?>
                                        <li>
                                            ...
                                            <span class="pub-detail-value pub-detail-value-oneline"><?= htmlspecialchars($svc['eligibility'] ?: 'Not specified') ?></span>
                                        </li>
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                                            ...
                                            <span class="pub-detail-value"><?= htmlspecialchars($svc['processing_time'] ?: 'Not specified') ?></span>
                                        </li>
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
