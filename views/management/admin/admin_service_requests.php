...
<div class="admin-layout">
    ...
    <main class="admin-content">
        ...
        <!-- <section class="off-widgets">
            ...
            <div class="off-widget-card widget-blue">
                <div class="widget-icon-wrap">
            ...
            <div class="off-widget-card widget-danger">
                <div class="widget-icon-wrap">
                ...
                <div class="widget-body">
                    <span class="widget-label">Rejected</span>
        ...
        <div class="req-controls-wrap">
            <div class="req-tabs" role="tablist">
                ...
                <button class="req-tab"        data-status="rejected"        role="tab">Rejected <span class="req-tab-count"><?= $counts['rejected'] ?></span></button>
        ...
        <div class="req-table-panel">
            ...
            <div class="panel-header">
                <h2 class="section-label">All Service Requests</h2>
                ...
                <table class="req-table" id="req-table">
                    ...
                    ?>
                        <tr data-id="<?= $req['id'] ?>"
                            ...
                            <td class="col-status">
                                <span class="req-status-pill status-<?= $statusCls ?>"><?= $statusLbl ?></span>
                            </td>
        ...
        <section class="req-pagination" id="req-pagination">
            ...
            <div class="req-page-numbers" id="req-page-numbers">
                <button class="req-page-num active" data-page="1">1</button>
            </div>
            <button class="req-page-btn" id="req-next-btn" disabled>Next &#8250;</button>
        </section>
...
<div class="req-modal-overlay" id="req-drawer-overlay" style="display:none;" aria-modal="true" role="dialog">
    <div class="req-modal" id="req-drawer">
        ...
        <div class="req-modal-body req-drawer-body" id="drawer-loading" style="display:none;">
            <p style="text-align:center;padding:40px 0;color:var(--ap-text-muted);">Loading details…</p>
        </div>
        ...
        <div class="req-modal-footer req-drawer-footer" id="req-drawer-footer"></div>
    ...
    <div class="req-action-modal">
        <div class="req-action-modal-header">
            <div class="req-action-modal-header-left">
                ...
                <h3 class="req-action-modal-title" id="decline-modal-title">Reject Application</h3>
            </div>
            <button class="req-action-modal-close" id="req-decline-modal-close" aria-label="Close">&times;</button>
        </div>
        <div class="req-action-modal-body">
            <p class="req-action-modal-desc">
                You must provide a reason. This will be saved to the resident's request thread and the application will be marked as <strong>Rejected</strong>. This action is final.
            </p>
            ...
            <textarea id="decline-modal-note" class="req-action-modal-textarea" rows="4"
                placeholder="Explain why this application is being rejected (e.g. incomplete documents, ineligible, duplicate request)…"></textarea>
        </div>
        <div class="req-action-modal-footer">
